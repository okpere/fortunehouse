...
const Partner = () => {
  return (
    <section className='partner'>
        ...
        <span><img src={opay} height ='100'/></span>
        <span><img src={plam} height ='100'/></span>
        <span><img src={addynamo} height ='100'/></span>
            <img src={Google} height ='100'/>
        <span><img src={meta} height ='100'/></span>
        <span><img src={pay} height ='100'/></span>
        </div>
    </section>
  )
}
